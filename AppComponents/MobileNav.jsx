...
const MobileNav = ({ user }) => {
  ...
  return (
    <Sheet>
      <SheetTrigger>
        <Image src="/icons/hamburger.svg" height={20} width={20} alt="menu" />
      </SheetTrigger>
      ...
      <SheetContent side="left" className=" bg-white flex flex-col gap-6">
        <div className=" flex gap-2">
          ...
          <h2 className=" text-lg font-bold font-ibm-plex-serif mt-0">
            {" "}
            Transact{" "}
          </h2>
        </div>
              ...
              return (
                <SheetClose asChild key={item.label}>
                  ...
                  >
                    ...
                    <p
                      className={cn("text-16 font-semibold text-amber-800", {
                        "text-white": isAtcive,
                      })}
                    >
                      {item.label}
